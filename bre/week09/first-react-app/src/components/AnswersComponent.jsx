    ...
    <>
      ...
      <Row>
        ...
        <div className="hide-form">
          <Link to="answers/add" className="btn btn-success">
            Add answer
          </Link>
        </div>
      </Row>
...
function AnswerTable(props) {
  ...
  const sortByScore = () => {
    setSortedBy((ord) =>
      ord === sortOrder.asc ? sortOrder.desc : sortOrder.asc
    );
  };
  ...
  return (
    <tr>
      ...
      <td className="actions">
        <AnswerActions answer={props.answer} voteUp={props.voteUp} />
      </td>
    </tr>
  );
}
...
function AnswerActions(props) {
  return (
    <>
      <Button variant="primary" onClick={() => props.voteUp(props.answer.id)}>
        {upIcon}
      </Button>
      <Link
        to={`answers/edit/${props.answer.id}`}
